/*
]=====> Wichello Devonius <=====[ ]=====> YT Wichello Devonius<=====[ ]=====> 087791540625 <=====[
*/
// HAI
// NGOTAK KNTL
...
const vcard = 'BEGIN:VCARD\n'
            ...
            + 'FN:Wichello\n' // GANTI NAMA LU
            + 'ORG:OWNER BOTZ;\n'
            + 'TEL;type=CELL;type=VOICE;waid=6287791540625:+62 81270318500\n' // GANTI NOMOR LU
            + 'END:VCARD'
...
console.log(banner.string)
   ...
   qrcode.generate(qr, { small: true })
	console.log(color('[','white'), color('!','red'), color(']','white'), color(' SUBSCRIBE YT  WICHELLO DEVONIUS'))
})
